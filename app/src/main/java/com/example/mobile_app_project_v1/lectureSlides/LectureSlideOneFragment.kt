...
class LectureSlideOneFragment : Fragment(R.layout.frame) {
...
//        textView.text = getString(R.string.lecture1)
        //getString(R.id.)
        ...
        pdf.fromAsset("Introduction_ Android Development with Kotlin.pdf").load()
