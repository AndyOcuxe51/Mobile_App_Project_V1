...
class LectureSlideTenFragment : Fragment(R.layout.frame) {
...
//        textView.text = getString(R.string.lectureslide10)
        //getString(R.id.)

        val pdf = binding.pdfview
        pdf.fromAsset("Lesson 10_ Advanced RecyclerView use cases.pdf").load()
