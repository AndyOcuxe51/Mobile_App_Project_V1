...
class LectureSlideNineFragment : Fragment(R.layout.frame) {
    ...
    override fun onCreateView(
        ...
        textView.text = getString(R.string.lectureslide9)
        //getString(R.id.)
        ...
        pdf.fromAsset("Lesson 9_ App architecture (persistence).pdf").load()
