...
class LectureSlideFourFragment : Fragment(R.layout.frame) {
...
//        textView.text = getString(R.string.lectureslide4)
        //getString(R.id.)
        ...
        pdf.fromAsset("Lesson 4_ Build your first Android app.pdf").load()
