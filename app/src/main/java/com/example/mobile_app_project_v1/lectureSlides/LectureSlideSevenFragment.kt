...
class LectureSlideSevenFragment : Fragment(R.layout.frame) {
...
//        textView.text = getString(R.string.lectureslide7)
        //getString(R.id.)
        ...
        pdf.fromAsset("Lesson 7_ Activity and Fragment Lifecycles.pdf").load()
